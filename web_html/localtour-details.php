		...
		<div class="row">
			<div class="col-md-7">
				<div class="detail-bx1">
					<h1>The Classic One Day tour of the Floating Market</h1>
					<div class="rate">
				...
				<div class="detail-bx2">
					...
					<div class="detail-bx2-inr">
						...
						<div class="flavor">
							...
							<label for="radio1" class="option11 m-0">Bang Pa-In Summer Palace & Floating Market</label>
						</div>
						<h4 class="tlt">Date (Please select a tour date)</h4>
						<select>
						...
						<div class="total">
							...
							<div class="total-bx">
								...
								<button><a href="localtour-booking.php" style="color:#fff">Book Now</a></button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="detail-bx5">
					...
					<img src="images/details-img2.jpg">
					<h6>8:30am meet up at century mall (BTS Victory Monument station)</h6>
					<img src="images/details-img2.jpg">

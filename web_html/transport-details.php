		...
		<div class="row">
			<div class="col-md-7">
				<div class="detail-bx1">
					<h1>Private Suvarnabhumi Airport Transfer for bangkok, Pattaya & More by Oriental Holiday</h1>
					<div class="rate">
				...
				<div class="detail-bx2">
					...
					<div class="detail-bx2-inr">
						...
						<div class="flavor">
							...
							<label for="radio1" class="option11">Bangkok - Downtown</label>
							<input type="radio" id="radio2" name="flavor" value="2" />
							<label for="radio2" class="option11">Bangkok - Pattaya</label>
							<input type="radio" id="radio3" name="flavor" value="2" />
							<label for="radio3" class="option11">Bangkok - Hua Hin</label>
						</div>
						<h4 class="tlt">Please select your flight arrival date or hotel pick up date</h4>
						<select>
						...
						<div class="cards">
							<h4>Per Car (Deluxe Sedan)</h4>
							<div class="price">
								<strike>฿ 235.35</strike>
								<span>฿ 111.30</span>
							</div>
							<div class="quty-slct">
						...
						<div class="total">
							...
							<div class="total-bx">
								...
								<button><a href="transport-booking.php" style="color:#fff">Book Now</a></button>
							</div>
						</div>
					</div>
				</div>

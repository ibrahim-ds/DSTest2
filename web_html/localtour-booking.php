...
<section class="booking">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-5">
				<div class="total">
					<h6>The Classic One Day tour of the Floating market</h6>
					<table>
						<tr>
							<td>Package Type</td>
							<td>Bang Pa-In Summer Palace & Floating Market</td>
						</tr>
						<tr>
							<td>Date</td>
							<td>18/11/2019</td>
				...
				<div class="total">
					<table>
						<tr>
							<td>Total</td>
							<td style="font-size:18px;">฿ 111.90</td>
						</tr>
						<tr>
							<td style="width:auto;">Payment Amount</td>
							<td style="font-size:18px;">฿ 111.90</td>
						</tr>
					</table>
				</div>
